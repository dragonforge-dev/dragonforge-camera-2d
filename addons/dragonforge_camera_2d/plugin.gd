...
func _enable_plugin() -> void:
	...
	Action.add(ZOOM_IN, Action.joy_axis(JOY_AXIS_RIGHT_Y, Action.AXIS_UP), Action.key(KEY_PAGEUP))
	Action.add(ZOOM_OUT, Action.joy_axis(JOY_AXIS_RIGHT_Y, Action.AXIS_DOWN), Action.key(KEY_PAGEDOWN))
